#!/usr/bin/env python3
"""
Script pour insérer des données avec des IDs entiers
"""
import sys
import os
...
def create_products():
    """Créer les produits avec IDs entiers"""
    db = SessionLocal()
    ...
    try:
        ...
        for product_data in products_data:
            ...
            existing = db.query(Produit).filter(Produit.nom == product_data["nom"]).first()
            if not existing:
...
def main():
    print("=== Script d'insertion de données avec IDs entiers ===")
